...
// didAbort(error). Evaluation yields between operator evaluations.
// Re-entrant runs queue behind the in-flight run, so no other evaluation
// mutates pulse state while an operator is suspended; an abort surfaces as
// a rejection of the in-flight run promise with the signal's reason.
